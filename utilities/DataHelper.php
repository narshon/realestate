...
class DataHelper {
    //put your code here
    public function getModalButton($model, $viewfile, $title, $button_class,$label='New'){
        $model_name = $this->getModelNameFromViewFile($viewfile);
        $data = Html::a($label, ['#'], ['class' => $button_class,  'onclick'=>"showBSdialog('$model_name','$model->id','$viewfile','$title'); return false;"]);
