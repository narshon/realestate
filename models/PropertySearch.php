...
class PropertySearch extends Property
{
    ...
    public function rules()
    {
        return [
            ...
            [['property_name', 'property_desc', 'management_id', 'owner_id', '_status',  'property_video_url', 'management','owner','propertyType'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->joinWith(['management','owner']);
        ...
        // The tables are the ones our relation are configured to
        // in my case they are prefixed with "tbl_"
        'asc' => ['sys_users.profile_desc' => SORT_ASC],
        'desc' => ['sys_users.profile_desc' => SORT_DESC],
        ];
        ...
        $query->andFilterWhere([
            're_property.id' => $this->id,
            'property_type' => $this->property_type,
			'fk_property_location'=>$this->fk_property_location,
        ...
        $query->andFilterWhere(['like', 'property_name', $this->property_name])
            ...
            ->andFilterWhere(['like', 'sys_users.name1', $this->owner])
