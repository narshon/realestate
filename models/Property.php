 ...
 * @property integer $fk_property_location
...
class Property extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['property_name','fk_property_location','management_id','owner_id'], 'required'],
            [['id', 'property_type','fk_property_location','management_id', 'owner_id', '_status', 'created_by', 'modified_by'], 'integer'],
            [['property_desc',  'property_video_url'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'fk_property_location' => 'Property Location',
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getFkPropertyLocation()
    {
        return $this->hasOne(Estate::className(), ['id' => 'fk_property_location']);
    }
    /**
     * @return \yii\db\ActiveQuery
     */
    ...
    public function propertyPost(){
       ...
       // $propert_details  .= '<li class="list-group-item"><span class="property_desc"> '. isset($this->management)?$this->management->management_name:''.'</span></li>';
...
VIEW;
    ...
    public static function getName($property_id){
        $property = Self::find()->where(['id'=>$property_id])->one();
        if($property){
            return $property->property_name;
        }
    }
    
    public function getPropertyNameLink(){
        return Html::a(Html::encode($this->property_name), ['property/view', 'id' => $this->id]);
    }
