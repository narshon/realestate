...
?>
    ...
    <?= $form->field($model, 'Description')->textInput(['maxlength' => true]) ?>
       ...
       <div class="form-group">
        ...
        <?= Html::submitButton($model->isNewRecord ? 'Create' : 'Update', ['class' =>'btn btn-danger btn-create','onclick'=>"ajaxFormSubmit('$url','$view_name-form-div-$id','$view_name-form-$id',1,0); return false;"]) ?>
