...
?>
    ...
    <?= $form->field($model, 'fk_subcounty')->widget(Select2::classname(), [
    ...
    <?= $form->field($model, 'ward_lat')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'ward_long')->textInput(['maxlength' => true]) ?>
