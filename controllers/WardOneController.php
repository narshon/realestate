...
/**
 * WardOneController implements the CRUD actions for WardOne model.
 */
class WardOneController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Displays a single WardOne model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing WardOne model.
    ...
    /**
     * Deletes an existing WardOne model.
    ...
    /**
     * Finds the WardOne model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return WardOne the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = WardOne::findOne($id)) !== null) {
            return $model;
        } else {
