...
/**
 * SubcountyController implements the CRUD actions for Subcounty model.
 */
class SubcountyController extends Controller
{
    ...
    /**
     * Displays a single Subcounty model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Deletes an existing Subcounty model.
    ...
    /**
     * Finds the Subcounty model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Subcounty the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Subcounty::findOne($id)) !== null) {
            return $model;
        } else {
