...
use app\models\AccountMapSearch;
...
class AccountMapController extends Controller
{
    ...
    /**
     * Lists all AccountMap models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new AccountMapSearch();
    ...
    /**
     * Displays a single AccountMap model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new AccountMap model.
    ...
    /**
     * Updates an existing AccountMap model.
    ...
    /**
     * Deletes an existing AccountMap model.
    ...
    /**
     * Finds the AccountMap model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return AccountMap the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = AccountMap::findOne($id)) !== null) {
            return $model;
        } else {
